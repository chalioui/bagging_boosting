...
check_ntree <- replicate(10,
          sapply( c(1, 2, 5, 10, 20, 50, 100, 200, 500), function(x) round(taux.erreur(predict(randomForest(Clived ~., data = data.Train,ntree=x,mtry=1), newdata = data.Test) ,(data.Test$Clived)),4) ),simplify = FALSE
) 
